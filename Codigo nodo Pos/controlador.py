...
"""
Punto para añadir nuevos nodos
...
def registrarNuevoNodo():
    ...
    tiempo = nodo.get("tiempo")
    nodos[direccion] = [nombre,tiempo]
...
"""
Punto que devuelve los nodos que hay en la red.
...
"""
Metodo para poder incrementar el tiempo que llevan unidos los nodos
"""
def incrementarTiempo():
    for nodo in nodos.keys():
        nodos[nodo][1] = nodos[nodo][1] + 1
    
"""
Metodo para poder gestionar como se incrementa el tiempo de los nodos.
Para esto, se hace un bucle para incrementar cada minuto el tiempo de los nodos.
"""
